...
namespace CookBookApp.Behaviors
{
    class EventToCommandBehavior : BehaviorBase<VisualElement>
    {
        ...
        void RegisterEvent(string name)
        {
           ...
           typeof(EventToCommandBehavior).GetTypeInfo().GetDeclaredMethod("OnEvent");
        ...
        static void OnEventNameChanged(BindableObject bindable, object oldValue,
       object newValue)
        {
